...
var setCustomSelect = function setCustomSelect(select) {
  var button = select.querySelector('[data-select-button]').querySelector('.custom-select__text');
  var options = select.querySelectorAll('[data-select-value]');
  var input = select.querySelector('[data-select-input]');
  var value;
  var prevActiveOption;
  var index;
...
var breakpointMedia = window.matchMedia('(min-width: 768px)');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initRangeSlider: function() { return /* binding */ initRangeSlider; }
/* harmony export */ });
var initRangeSlider = function initRangeSlider() {
  var wrapper = document.querySelector('[data-range]');
  if (!wrapper) {
    return;
  }
  var number = wrapper.querySelector('[data-range-number]');
  var input = wrapper.querySelector('[data-range-input]');
...
/* harmony import */ var _modules_init_range_slider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/init-range-slider.js */ "./js/modules/init-range-slider.js");
/* harmony import */ var _modules_init_custom_select_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-custom-select.js */ "./js/modules/init-custom-select.js");
...
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    ...
    (0,_modules_init_range_slider_js__WEBPACK_IMPORTED_MODULE_1__.initRangeSlider)();
    (0,_modules_init_custom_select_js__WEBPACK_IMPORTED_MODULE_2__.initCustomSelect)();
  });
});
}();
/******/ })()
